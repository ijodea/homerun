...
export class TransportService {
  ...
  async getRankedOptions(currentTime: Date, day: string) {
    ...
    // const mStationToMju =
    //   elToMju !== null
    //     ? this.shuttleService.getMStationTimeGtoM(currentTime)
    //     : null;
    // const directShuttleGtoM = this.shuttleService.getGStationTimeGtoM(
    //   day,
    //   currentTime,
    // );
    ...
    //     waitingTime: elToMju,
    //     totalTime:
    //       elToMju !== null && mStationToMju !== null
    //         ? elToMju + mStationToMju
    //         : null,
    //     cost: 1450,
    //     ...(() => {
    ...
    // // 2. 명지대 → 기흥역
    // const mStationToGiheung =
    //   await this.shuttleService.getMStationTimeMtoG(currentTime);
    // const elToGiheung =
    //   mStationToGiheung !== null
    //     ? await this.shuttleService.getEverlineTimeMtoG(currentTime)
    //     : null;
    // const directShuttleMtoG = await this.shuttleService.getGStationTimeMtoG(
    //   day,
    //   currentTime,
    // );
    ...
    //     totalTime:
    //       mStationToGiheung !== null && elToGiheung !== null
    //         ? mStationToGiheung + elToGiheung
    //         : null,
    //     cost: 1450,
    //     ...(() => {
